...
form.addEventListener("submit", async (event) => {
  ...
  else if (statusBuy.statusBuy == "Error with transaction")
  {
    alert("Error al tratar realizar la transacción.");
  }
  else if (statusBuy.statusBuy == "No enough units")
  {
    alert("No se cuenta con unidades suficientes. Por favor, reduzca el número de unidades que desea comprar.");
  }
  else
  {
    alert("Alguno de los campos no está completo. Por favor, rellene los campos que faltan para finalizar su compra.");
  }
